    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        <motion.div
          ...
          className={`bg-gradient-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-xl rounded-3xl p-8 md:p-12 border ${currentTheme.border} relative overflow-hidden shadow-2xl`}
          style={{ transform: 'translate3d(0,0,0)' }}
        >
          <div
            className={`absolute inset-0 bg-gradient-to-br ${currentTheme.gradientFrom}/5 ${currentTheme.gradientTo}/5`}
          />
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="flex justify-center items-center">
                <motion.div
                  ...
                  className={`relative w-40 h-40 rounded-2xl flex items-center justify-center border-2 ${currentTheme.border} bg-gradient-to-br from-gray-800/20 to-gray-900/20 backdrop-blur-sm shadow-xl`}
                >
